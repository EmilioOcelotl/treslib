...
export default class ClothMeshManager {
    ...
    multiWave(x, y, t) {
        const { amplitude1, frequency1, amplitude2, frequency2 } = this.waveParams;
        const wave1 = Math.sin(x * frequency1 + t * 1.0) * amplitude1;
        const wave2 = Math.cos(x * frequency2 + y * 2.0 + t * 1.3) * amplitude2;
